...
public class SetActive : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (SceneManager.GetActiveScene().name == "Map23" || SceneManager.GetActiveScene().name == "FullMap22")
        {
            if (Input.GetMouseButtonDown(0))
            {
                if (gameObject != null)
                {
                    ...
                    if (state == true)
                    {
                        Target.SetActive(false);
                        print("사라져");
                        SceneManager.LoadScene("FullMap22");
                        state = false;
                    }
                    else
                    {
                        Target.SetActive(true);
                        print("생겨나");
                        SceneManager.LoadScene("Map23");
                        state = true;
                    }
                }
            }
        }
        if (SceneManager.GetActiveScene().name == "Map24" || SceneManager.GetActiveScene().name == "FullMap23")
        {
            if (Input.GetMouseButtonDown(0))
            {
                if (gameObject != null)
                {
                    ...
                    if (state == true)
                    {
                        Target.SetActive(false);
                        print("사라져");
                        SceneManager.LoadScene("FullMap23");
                        state = false;
                    }
                    else
                    {
                        Target.SetActive(true);
                        print("생겨나");
                        SceneManager.LoadScene("Map24");
                        state = true;
                    }
                }
            }
        }
        if (SceneManager.GetActiveScene().name == "Map25" || SceneManager.GetActiveScene().name == "FullMap24")
        {
            if (Input.GetMouseButtonDown(0))
            {
                if (gameObject != null)
                {
                    ...
                    if (state == true)
                    {
                        Target.SetActive(false);
                        print("사라져");
                        SceneManager.LoadScene("FullMap24");
                        state = false;
                    }
                    else
                    {
